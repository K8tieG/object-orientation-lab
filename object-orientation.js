...
/*
  ...
  with the value being your favorite car and then another key named 'brand' with the value being your favorite brand.
*/

favoriteThings.car = 'VW Bug'
...
let Harry = new Wizard('Harry', 16, 'Alohomora')
...
let phone1 = new Phone('Apple','iphone 12', 16, 'pink', 1000)
let phone2 = new Phone('Samsung','Galaxy', 16, 'black', 900)
let phone3 = new Phone('LG','Blade', 16, 'silver', 800)
